...
status_t mma8652_read_xyz(int32_t* data)
{
    ...
    if(mma8652_cfg & MMA8652_RES_8){
    	raw_x = (int16_t)(buf[0]<<8);
    	raw_y = (int16_t)(buf[2]<<8);
    	raw_z = (int16_t)(buf[4]<<8);
    }else{
    ...
    switch(scale){
    	case MMA8652_SCALE_2G:
    		data[0] = (1000 * raw_x + 512)>>10;
    		data[1] = (1000 * raw_y + 512)>>10;
    		data[2] = (1000 * raw_z + 512)>>10;
    		break;
    	case MMA8652_SCALE_4G:
    		data[0] = (1000 * raw_x + 256)>>9;
    		data[1] = (1000 * raw_y + 256)>>9;
    		data[2] = (1000 * raw_z + 256)>>9;
    		break;
    	case MMA8652_SCALE_8G:
    		data[0] = (1000 * raw_x + 128)>>8;
    		data[1] = (1000 * raw_y + 128)>>8;
    		data[2] = (1000 * raw_z + 128)>>8;
    		break;
    }
